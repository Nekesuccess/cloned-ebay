...
const Trello = () => {
  ...
  return (
    <div className='Trello-Header-Wrapper'>
      <div className='Trello-Header-Container'>
        <div className='Trello-left-side'>
        ...
        <ul className='navstyle1'>
          <li>Features <IoIosArrowDown /></li>
           <li>Solutions <IoIosArrowDown /></li>
          <li>Plans <IoIosArrowDown /> </li>
          <li> Pricing <IoIosArrowDown /></li>
          </ul>
          
        </div>
        <div className='Trello-right-side'>
          <h3>Log in</h3>
          <button className='button-style-trello'>Get Trello for free</button>
        ...
        <div className="dropdown-menu">
          ...
          <button className="dropdown-button">Get Trello for free</button>
          <button className="dropdown-button2">Log in</button>
